...
const CandidateProfile = () => {
  ...
  const handleGenerateCoverLetter = async () => {
    ...
    const toneText = coverLetterForm.tone === "professional" ? "رسمي واحترافي" : coverLetterForm.tone === "friendly" ? "ودي ومتحمس" : "مباشر وموجز";
...
${candidate.phone}`;
  ...
  if (!candidate) {
    return <div className="min-h-screen bg-background flex items-center justify-center" dir="rtl">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {isCompanyView && <Badge className={`${candidate.matchScore >= 90 ? "bg-emerald-500" : candidate.matchScore >= 80 ? "bg-primary" : "bg-amber-500"}`}>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {candidate.appliedJobs.map((job, index) => <div key={job.id} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg border border-border/50">
                    ...
                    <Badge variant={job.status === "accepted" ? "default" : job.status === "rejected" ? "destructive" : "secondary"} className={`flex items-center gap-1 ${job.status === "accepted" ? "bg-emerald-500" : ""}`}>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => setIsCoverLetterDialogOpen(true)} className="gap-2">
          ...
          <Card>
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {candidate.skills.map((skill, index) => <Badge key={index} variant="secondary">{skill}</Badge>)}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {candidate.languages.map((lang, index) => <li key={index} className="text-sm">{lang}</li>)}
                </ul>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={coverLetterForm.tone} onValueChange={v => setCoverLetterForm({
                ...coverLetterForm,
                tone: v
              })}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input value={coverLetterForm.targetRole} onChange={e => setCoverLetterForm({
                ...coverLetterForm,
              ...
              <div className="space-y-2">
                ...
                <Textarea value={coverLetterForm.highlights} onChange={e => setCoverLetterForm({
                ...coverLetterForm,
                highlights: e.target.value
              })} placeholder="مثال: خبرة في قيادة الفرق، مشاريع ناجحة..." rows={3} />
              </div>

              <Button onClick={handleGenerateCoverLetter} disabled={isGenerating} className="w-full gap-2">
                {isGenerating ? <>

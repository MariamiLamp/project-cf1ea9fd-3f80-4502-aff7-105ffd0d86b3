...
const HRRegistration = () => {
  ...
  const steps = [
    { number: 1, title: "المعلومات الأساسية", icon: UserCheck },
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">أكمل ملفك الشخصي كمسؤول توظيف</p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="اكتب نبذة مختصرة عن خبرتك في مجال التوظيف..."
                  ...
                  {/* Skills */}
                  <div>
                    <Label>المهارات التوظيفية</Label>
                    <div className="flex gap-2 mt-1">
                      <Input
                        value={newSkill}
                        onChange={(e) => setNewSkill(e.target.value)}
                        placeholder="أضف مهارة (مثال: Screening, Interviewing)"
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  {/* CV Upload */}
                  <div>
                    <Label>السيرة الذاتية (للملف المهني)</Label>
                    <div className="mt-2">
                      <label
                        htmlFor="cv"
                  ...
                  {/* Certificates Upload */}
                  <div>
                    <Label>الشهادات المهنية (CIPD, SHRM, etc)</Label>
                    <div className="mt-2">
                      <label
